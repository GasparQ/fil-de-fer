...
def draw_decreased(img, f_point, s_point, color):
    mine_color = color[0]
    if (s_point.x - f_point.x >= f_point.y - s_point.y):
        g = f_point.x
        ...
        if (f_point.x != s_point.x):
            while (g <= s_point.x):
                ...
                g = g + 1
    elif (s_point.x - f_point.x <= f_point.y - s_point.y):
        g = s_point.y
...
def draw_increased(img, f_point, s_point, color):
    mine_color = color[0]
    if (s_point.x - f_point.x >= s_point.y - f_point.y):
        g = f_point.x
        pixel_nbr = s_point.x - f_point.x
        if (f_point.x != s_point.x):
            while (g <= s_point.x):
                ...
                mine_color = search_color(color, mine_color, pixel_nbr)
                g = g + 1
    elif (s_point.x - f_point.x <= s_point.y - f_point.y):
        g = f_point.y
